...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="classification" content="Vortice Serviços, JuriWeb, Processos, Petições, J2EE, Desenvolvimento, Sistemas WEB, .NET, tableless, css" />
		<meta name="description" content="Site da Empresa Vortice, empresa de desenvolvimento web." />
		<meta name="distribution" content="Global" />
		
		<meta name="rating" content="General" />
		<meta name="author" content="Antonio Fernando Amorim - fernando@vorticeservicos.info" />
	...
	<body onload="MM_preloadImages('<c:url value="/site/tema01/menu01_on.gif"/>, <c:url value="/site/tema01/menu02_on.gif"/>, <c:url value="/site/tema01/menu03_on.gif"/>')">
		<div id="geral">
			<div id="topo">
				...
				<a href="<c:url value="/site/servicos.jsp"/>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('menu02','','<c:url value="/site/tema01/menu02_on.gif"/>',1)">
					<img src="<c:url value="/site/tema01/menu02_off.gif"/>" name="menu02" border="0" id="menu02" />
				</a>
				<a href="<c:url value="/site/contato.jsp"/>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('menu03','','<c:url value="/site/tema01/menu03_on.gif"/>',1)">
