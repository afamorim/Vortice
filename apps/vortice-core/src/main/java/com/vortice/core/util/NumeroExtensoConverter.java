...
/**
 * Classe respons�vel por receber um n�mero decimal e converter para 
 * Uma descri��o em extenso em portugu�s somente.  
 * @author Amadeu
 *
 */
public class NumeroExtensoConverter {
	 ...
	 */
	public NumeroExtensoConverter(BigDecimal dec) {
		this();
		setNumber(dec);
	}
	 ...
	 *@param  dec  valor para colocar por extenso
	 */
	public NumeroExtensoConverter(double dec) {
		this();
		setNumber(dec);
	}
  ...
  public static void main(String[] args) {
		...
		//Extenso teste = new Extenso(new BigDecimal("12300.59"));
